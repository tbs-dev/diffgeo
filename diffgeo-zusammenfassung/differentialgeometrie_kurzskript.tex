...
\end{de}
\begin{lem}[Invarianz der Krümmung]
	
\end{lem}
\begin{de}[Evolute]
	
\end{de}
\begin{lem}[Formeln von Frenet-Serret in der Ebene]
...
\end{proof}
\begin{theo}[Fundamentalsatz der ebenen Kurventheorie]
...
\end{de}
\begin{de}[Orientierte Basis]
	Eine orthonormale Basis $(\vek{e}_1,\vek{e}_2,\vek{e}_3)$ des $\R^3$ heißt \textit{orientiert}, falls \[ \det(\vek{e}_1,\vek{e}_2,\vek{e}_3)=1. \]
\end{de}
\begin{lem}[Krümmung einer Raumkurve]
	Sei $c:[a,b]\to \R^3$ eine reguläre $C^2$-Kurve. Ihre Krümmung ist dann gegeben durch \[ \kappa(t)=\frac{\norm{\dot{c}(t)\times \ddot{c}(t)}}{\norm{\dot{c}(t)}^3}. \]
\end{lem}
\begin{proof}
	Inhalt...
\end{proof}
\begin{de}[Ordnung der Regularität]

\end{de}
\begin{lem}[Invarianz der Regularität]
	
\end{lem}
\begin{proof}
	Inhalt...
\end{proof}
\begin{de}[Frenet-3-Bein]
	
\end{de}
\begin{lem}[Invarianz des Frenet-3-Beins]

\end{lem}
\begin{de}[Torsion]
	
\end{de}
\begin{theo}[Formeln von Frenet-Serret]
	
\end{theo}
\begin{theo}[Fundamentalsatz der lokalen Kurventheorie im $\R^3$]
	
\end{theo}
\begin{de}[spährisch]
	
\end{de}
\begin{de}[Krümmungs- und Totsionsradius]
	
\end{de}
\section{Lokale Kurventheorie im $\R^n$}
\begin{de}[Frenet-$n$-Bein]
	
\end{de}
\begin{de}[Orientierung]
	
\end{de}
\begin{de}[aF-$n$-Bein]

\end{de}
\begin{theo}[Existenz- und Eindeutigkeitssatz des aF-$n$-Beins]
	
\end{theo}
\begin{lem}[Verhalten von aF-$n$-Beinen unter Parametertransformation]

\end{lem}
\begin{lem}[Verhalten von aF-$n$-Beinen unter Euklidischen Bewegungen]
	
\end{lem}
\begin{theo}[Ableitungsgleichungen von Frenet]
	
\end{theo}
\begin{de}[$i$-te Krümmung einer Kurve]
	
\end{de}
\begin{lem}[Invarianz der $i$-ten Krümmung unter Euklidischer Bewegung]
	
\end{lem}
\begin{theo}[Fundamentalsatz der lokalen Kurventheorie]
